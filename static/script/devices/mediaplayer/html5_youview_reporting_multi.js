...
define(
  ...
  function (RuntimeContext, Device, MediaPlayer) {
    ...
    var Player = MediaPlayer.extend({
       ...
       * @inheritDoc
       */
      setSource: function setSource(mediaType, url, mimeType, crid, appId) {
        this._adState = false;
        this.mainPlayerState = null;
        this._mainMediaElement = null;
        this._mainSourceElement = null;
      ...
      _setWrapEvents: function () {
        ...
        this._wrapOnAdMetadata = function () {
          self._onMetadata();
        };
      ...
      _addMediaElementEvents: function _addMediaElementEvents(ad) {
        ...
        this._mediaElement.addEventListener('loadedmetadata', this["_wrapOn" + (ad || "") + "Metadata"], false);
      ...
      _removeMediaElementEvents: function _removeMediaElementEvents(ad) {
      ...
      createReport: function () {
        clearTimeout(this.createReportRef);
        if (!this._adState && !this.reportCreated) {
          ...
          try {
            if (isOD) {
              reportAttributes = youview.reporting.ReportFactory.createMediaAttributesForOnDemand(appId, youview.reporting.MediaTypeValues.OD_CATCH_UP, crid);
            }
            if (isLive) {
              reportAttributes = window.youview.reporting.ReportFactory.createMediaAttributesForLive(
                appContext, window.youview.reporting.MediaTypeValues.LIVE, mediaId);
            }
            var mediaElement = this._mainMediaElement || this._mediaElement;
            youview.reporting.ReportFactory.createReport(mediaElement, reportAttributes);
          ...
          var scope = this;
          this.createReportRef = setTimeout(function () {
            scope.createReport();
          }, 500);
        }
      },
      /////////////////////////////////////////////
      //Multi video object handling for ad support
      /////////////////////////////////////////////
      setAdSource: function setAdSource(mediaType, url, mimeType) {
        ...
        var self = this;
        this._setWrapEvents();
        this._addMediaElementEvents("Ad");
      ...
      captureMainPlayerState: function () {
        ...
        this._enterBufferingSentinelAttemptCount ? this.mainPlayerState._enterBufferingSentinelAttemptCount = this._enterBufferingSentinelAttemptCount : null;
        this._hasSentinelTimeChangedWithinTolerance ? this.mainPlayerState._hasSentinelTimeChangedWithinTolerance = this._hasSentinelTimeChangedWithinTolerance : null;
        this._ignoreNextPauseEvent ? this.mainPlayerState._ignoreNextPauseEvent = this._ignoreNextPauseEvent : null;
        this._lastSentinelTime ? this.mainPlayerState._lastSentinelTime = this._lastSentinelTime : null;
        this._mediaElement ? this.mainPlayerState._mediaElement = this._mediaElement : null;
        this._mimeType ? this.mainPlayerState._mimeType = this._mimeType : null;
        this._nearEndOfMedia ? this.mainPlayerState._nearEndOfMedia = this._nearEndOfMedia : null;
        this._postBufferingState ? this.mainPlayerState._postBufferingState = this._postBufferingState : null;
        this._readyToPlayFrom ? this.mainPlayerState._readyToPlayFrom = this._readyToPlayFrom : null;
        this._seekSentinelTolerance ? this.mainPlayerState._seekSentinelTolerance = this._seekSentinelTolerance : null;
        this._sentinelInterval ? this.mainPlayerState._sentinelInterval = this._sentinelInterval : null;
        this._sentinelIntervalNumber ? this.mainPlayerState._sentinelIntervalNumber = this._sentinelIntervalNumber : null;
        this._sentinelSeekTime ? this.mainPlayerState._sentinelSeekTime = this._sentinelSeekTime : null;
        this._source ? this.mainPlayerState._source = this._source : null;
        this._sourceElement ? this.mainPlayerState._sourceElement = this._sourceElement : null;
        this._state ? this.mainPlayerState._state = this._state : null;
        this._targetSeekTime ? this.mainPlayerState._targetSeekTime = this._targetSeekTime : null;
        this._trustZeroes ? this.mainPlayerState._trustZeroes = this._trustZeroes : null;
        this._type ? this.mainPlayerState._type = this._type : null;
        this._adState ? this.mainPlayerState._adState = this._adState : this.mainPlayerState._adState = false;
      },
      restoreMainPlayerState: function () {
        if (this.mainPlayerState) {
          this.mainPlayerState._enterBufferingSentinelAttemptCount ? this._enterBufferingSentinelAttemptCount = this.mainPlayerState._enterBufferingSentinelAttemptCount : null;
          this.mainPlayerState._hasSentinelTimeChangedWithinTolerance ? this._hasSentinelTimeChangedWithinTolerance = this.mainPlayerState._hasSentinelTimeChangedWithinTolerance : null;
          this.mainPlayerState._ignoreNextPauseEvent ? this._ignoreNextPauseEvent = this.mainPlayerState._ignoreNextPauseEvent : null;
          this.mainPlayerState._lastSentinelTime ? this._lastSentinelTime = this.mainPlayerState._lastSentinelTime : null;
          this.mainPlayerState._mediaElement ? this._mediaElement = this.mainPlayerState._mediaElement : null;
          this.mainPlayerState._mimeType ? this._mimeType = this.mainPlayerState._mimeType : null;
          this.mainPlayerState._nearEndOfMedia ? this._nearEndOfMedia = this.mainPlayerState._nearEndOfMedia : null;
          this.mainPlayerState._postBufferingState ? this._postBufferingState = this.mainPlayerState._postBufferingState : null;
          //          this._readyToPlayFrom = true;
          this.mainPlayerState._readyToPlayFrom ? this._readyToPlayFrom = this.mainPlayerState._readyToPlayFrom : false;
          this.mainPlayerState._seekSentinelTolerance ? this._seekSentinelTolerance = this.mainPlayerState._seekSentinelTolerance : null;
          this.mainPlayerState._sentinelInterval ? this._sentinelInterval = this.mainPlayerState._sentinelInterval : null;
          this.mainPlayerState._sentinelIntervalNumber ? this._sentinelIntervalNumber = this.mainPlayerState._sentinelIntervalNumber : null;
          this.mainPlayerState._sentinelSeekTime ? this._sentinelSeekTime = this.mainPlayerState._sentinelSeekTime : null;
          this.mainPlayerState._source ? this._source = this.mainPlayerState._source : null;
          this.mainPlayerState._sourceElement ? this._sourceElement = this.mainPlayerState._sourceElement : null;
          this.mainPlayerState._state ? this._state = this.mainPlayerState._state : null;
          this.mainPlayerState._targetSeekTime ? this._targetSeekTime = this.mainPlayerState._targetSeekTime : null;
          this.mainPlayerState._trustZeroes ? this._trustZeroes = this.mainPlayerState._trustZeroes : null;
          this.mainPlayerState._type ? this._type = this.mainPlayerState._type : null;
          this.mainPlayerState._adState ? this._adState = this.mainPlayerState._adState : this.mainPlayerState._adState = false;
          this._mainMediaElement = null;
          this._mainSourceElement = null;
        }
      },
      ...
      resumeMainSource: function (seconds) {
        ...
        this._mediaElement ? this.showPlayer(this._mediaElement) : null;
        switch (this.getState()) {
          case MediaPlayer.STATE.STOPPED:
            this.beginPlayback();
            if (seconds) {
      ...
      cleanUpVideo: function () {
        this.stop();
        this.reset();
        if (this._mainMediaElement && this._mainSourceElement) {
          this._mediaElement = this._mainMediaElement;
          this._sourceElement = this._mainSourceElement;
          this._destroyMediaElement();
        }
      }
    });
