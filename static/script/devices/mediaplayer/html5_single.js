  ...
  function (RuntimeContext, Device, MediaPlayer) {
    ...
    var Player = MediaPlayer.extend({
      ...
      setAdSource: function setAdSource(mediaType, url, mimeType) {
        this.adState ? null : this.captureMainPlayerState();
        this._adState = true;
      ...
      restoreMainPlayerState: function () {
        this._adState = this.mainPlayerState._adState;
      ...
      destroyAdSource: function destroyAdSource() {
        //        this._adState = false;
        //        if (this._mainMediaElement) {
        debugger
        this.restoreMainPlayerState();
        //          this._mediaElement = this._mainMediaElement;
        //          this._mainSourceElement ? this._sourceElement = this._mainSourceElement : null;
