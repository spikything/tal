...
define(
  ...
  function (Device, BasePgHandler, PgChallengeResponse) {
    ...
    var youViewPgHandler = BasePgHandler.extend({
      ...
      isPinRequired: function isPinRequired(cRating, isPinRequiredHandler) {
        youview.parentalControls.isPinRequired(cRating).then(isPinRequiredHandler, function (value) {
          throw new Error("Promise rejected error :: " + value);
        });
      }
    });
