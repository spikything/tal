...
define(
  ...
  function (Class, Iterator, DataBoundEvent) {
    ...
    var Binder = Class.extend( /** @lends antie.widgets.carousel.Binder.prototype */ {
       ...
       * @param widget The parent of the widgets to be created.
       */
      prependAllTo: function prependAllTo(widget) {
        this._bindAll(widget, this._prependItem);
      },
      ...
      _prependItem: function _appendItem(widget, item) {
        return widget.insertChildWidget(0, item);
      }
    });
    return Binder;
  }
