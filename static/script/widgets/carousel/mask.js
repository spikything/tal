  ...
  function (Container, Spinner, BeforeAlignEvent, AfterAlignEvent) {
    ...
    Mask = Container.extend( /** @lends antie.widgets.carousel.Mask.prototype */ {
      ...
      _doAlign: function _doAlign(index, options, alignPoint) {
        ...
        distanceContentsMustMoveBack = Math.floor(this._widgetStrip.getLengthToIndex(index));
        ...
        //TODO: Find a real solution to this https://simplestream.atlassian.net/browse/AMC-243 instead of this dirty hack
        if (distanceContentsMustMoveBack == 356) {
          distanceContentsMustMoveBack = 355;
        }
        //==================================================
      ...
      _resetAlignment: function _resetAlignment() {
        if (this._lastAlignIndex !== null) {
          this._doAlign(this._lastAlignIndex, {
            skipAnim: true
          }, this._currentAlignPoint);
        }
      },
      ...
      _getWidgetAlignmentPoint: function _getWidgetAlignmentPoint(index) {
        ...
        return Math.floor(widgetAlignmentPoint);
      },
      ...
      _getAlignmentPoint: function _getAlignmentPoint() {
        ...
        return Math.floor(alignmentPoint);
      },
